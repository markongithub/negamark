...
module MySQLTranspositionTableModule where
  import Control.Exception
  import Database.HSQL.MySQL
  import Negamark

  instance TranspositionTable MySQLTranspositionTable where
  ...
  data MySQLTranspositionTable = MySQLTranspositionTable
  ...
  getOutcomeMySQL :: MySQLTranspositionTable -> Integer -> IO (Maybe Outcome)
...
--      putStrLn query_text
  ...
  saveOutcomeMySQL :: MySQLTranspositionTable -> Integer -> Outcome -> IO()
...
--  myTable = MySQLTranspositionTable myConn 8
