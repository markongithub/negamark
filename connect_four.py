...
class ConnectFourBoard(NegamarkBoard):
  ...
  def __init__(self, cache, prepopulated_squares=None):
    ...
    self.minimum_search_move = self.columns * self.rows
    self.zobrist = 0L
  ...
  def copy_board(self):
    ...
    new_board = ConnectFourBoard(prepopulated_squares=copied_squares,
                                 cache=self.cache)
...
def main():
  ...
  board.make_move(ConnectFourMove(1))
  board.make_move(ConnectFourMove(2))
  board.make_move(ConnectFourMove(1))
  board.make_move(ConnectFourMove(1))
  board.make_move(ConnectFourMove(1))
  board.make_move(ConnectFourMove(3))
  board.make_move(ConnectFourMove(1))
  board.make_move(ConnectFourMove(4))
#  board.make_move(ConnectFourMove(5))
#  board.make_move(ConnectFourMove(2))
#x4 o2 x2 o1 x2 o2 x0 o4 x4 o5 x0 o0 x0 o6 x4 o5 x5 o6
#  for column in [4, 2, 2, 1, 2, 2, 0, 4, 4, 5, 0, 0, 0, 6, 4, 5, 5, 6]:
#    board.make_move(ConnectFourMove(column))
  board.is_automated[NegamarkBoard.X] = True
  board.is_automated[NegamarkBoard.O] = False
  board.ai_deadline = 60*60*8
  board.minimum_search_move = 0
